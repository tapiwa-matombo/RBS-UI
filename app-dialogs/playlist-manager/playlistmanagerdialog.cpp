...
PlaylistManagerDialog::PlaylistManagerDialog(QSqlRelationalTableModel *albums, QDomDocument details,
...
void PlaylistManagerDialog::submit()
{
...
int PlaylistManagerDialog::findArtistId(const QString &artist)
{
...
int PlaylistManagerDialog::addNewArtist(const QString &name)
{
    QSqlTableModel *artistModel = model->relationModel(2);
    QSqlRecord record;
...
int PlaylistManagerDialog::addNewAlbum(const QString &title, int artistId)
{
...
void PlaylistManagerDialog::addTracks(int albumId, const QStringList &tracks)
{
...
void PlaylistManagerDialog::increaseAlbumCount(QModelIndex artistIndex)
{
    QSqlTableModel *artistModel = model->relationModel(2);
...
void PlaylistManagerDialog::revert()
{
    artistEditor->clear();
    titleEditor->clear();
...
QGroupBox *PlaylistManagerDialog::createInputWidgets()
{
...
QDialogButtonBox *PlaylistManagerDialog::createButtons()
{
    ...
    connect(closeButton, &QPushButton::clicked, this, &PlaylistManagerDialog::close);
    connect(revertButton, &QPushButton::clicked,  this, &PlaylistManagerDialog::revert);
    connect(submitButton, &QPushButton::clicked, this, &PlaylistManagerDialog::submit);
...
QModelIndex PlaylistManagerDialog::indexOfArtist(const QString &artist)
{
    QSqlTableModel *artistModel = model->relationModel(2);
...
int PlaylistManagerDialog::generateArtistId()
{
    uniqueArtistId += 1;
    return uniqueArtistId;
}

int PlaylistManagerDialog::generateAlbumId()
{
    uniqueAlbumId += 1;
